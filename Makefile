...
deps:
	...
	wget -O- https://github.com/facebookresearch/detectron2/commit/ed294fabf043eadbb33948d5c39f8f0361829a4f.patch | patch -d `$(PYTHON) -c "import detectron2; print(detectron2.__path__[0])"` -p2
